...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //彩种，奖金，玩法
	  ...
	  _createClass(Base, [{
	    ...
	    value: function initPlayList() {
	      this.play_list.set("r2", {
	        bonus: 6,
	        tip: '从01-11中任选2个或多个号码，所选号码与开奖海马任意两个号码相同，即中奖<em class="red">6</em>',
	        name: "任二"
	      }).set("r3", {
	        bonus: 19,
	        tip: '从01-11中任选3个或多个号码，选号与奖号任意三个号相同，即中奖<em class="red">19</em>',
	        name: "任三"
	      }).set("r4", {
	        bonus: 78,
	        tip: '从01-11中任选4个或多个号码，所选号码与开奖号码任意四个号码相同，即中奖<em class="red">78</em>',
	        name: "任四"
	      }).set("r5", {
	        bonus: 540,
	        tip: '从01-11中任选5个或多个号码，所选号码与开奖号码任意五个号码相同，即中奖<em class="red">540</em>',
	        name: "任五"
	      }).set("r6", {
	        bonus: 90,
	        tip: '从01-11中任选6个或多个号码，所选号码与开奖号码任意六个号码相同，即中奖<em class="red">90</em>',
	        name: "任六"
	      }).set("r7", {
	        bonus: 26,
	        tip: '从01-11中任选7个或多个号码，所选号码与开奖号码任意七个号码相同，即中奖<em class="red">26</em>',
	        name: "任七"
	      }).set("r8", {
	        bonus: 9,
	        tip: '从01-11中任选87个或多个号码，所选号码与开奖号码任意八个号码相同，即中奖<em class="red">9</em>',
	        name: "任八"
	      });
	    }
	    /**
...
/***/ (function(module, exports) {
	...
	var Calculate = function () {
	  ...
	  _createClass(Calculate, [{
	    ...
	    key: "combine",
	    value: function combine(arr, size, result) {
	      var allResult = [];
	      (function f() {
