...
export default {
  ...
  beforeMount: function() {
    ...
    this.foo()
    console.log('beforeMounted-li数量', document.getElementsByTagName('li').length)
    console.log('beforeMounted-p个数', document.getElementsByTagName('p').length)
  ...
  mounted: function() {
    ...
    console.log('引用的组件', document.getElementsByTagName('i').length)
  }
}
</script>
