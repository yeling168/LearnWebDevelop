...
export default {
  ...
  mounted: function() {
    ...
    console.log("mounted-p个数", document.getElementsByTagName("p").length);
  ...
  updated: function() {
    ...
    this.foo();
    console.log("updated-li数量", document.getElementsByTagName("li").length);
    console.log("updated-p个数", document.getElementsByTagName("p").length);
    console.log("updated", this.$el);
  },
  //beforeDestroy钩子
  beforeDestroy: function() {
    alert("window");
    console.group("beforeDestroy钩子执行");
    console.log("beforeDestroy钩子执行", this.message);
    this.foo();
    console.log(
      "beforeDestroy-li数量",
      document.getElementsByTagName("li").length
